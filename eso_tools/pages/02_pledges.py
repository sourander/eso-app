...
def main():
    ...
    st.markdown(f"""
        ...
        They are given by three NPC's, each giving a different set of dungeons. This tool will print the today's dungeon and the chosen amount of following days' dungeons.
